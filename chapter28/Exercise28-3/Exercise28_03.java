 ...
 * Date: 3/29/24
 * 
 * (Implement DFS using a stack) The depth-first search algorithm described 
 * in Listing 28.8 uses recursion. Write a new method that performs a 
 * depth-first search without using recursion, called dfsNonRecurs().
 */
